...
#+begin_src plantuml :file diagram1.svg :java -Djava.awt.headless=true :results file :exports results
  Alice -> Bob: sync call
...
** Another!
#+name: ditaa-figure
#+begin_src ditaa :file diagram2.svg :java -Djava.awt.headless=true :cmdline -T --svg :results file :exports results
+-----------+              +----------+
|   Foo     |              |   Bar    |
+------+----+              +------+---+
       |                          |
...
** Can it be?!
#+name: dot-figure
#+begin_src dot :file diagram4.svg :cmdline -Tsvg :results file :exports results
digraph {
    bgcolor=transparent;
    rankdir=LR;
    2 [label=hello];
...
#+LATEX_HEADER_EXTRA: \setmonofont{Liberation Mono}
